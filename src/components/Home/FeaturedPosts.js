...
const FeaturedPosts = ({blogs}) => {
    ...
    return (<section className="w-full mt-32 px-32 flex flex-col items-center">
        <h2 className="w-full inline-blogk font-bold capitalize text-4xl">Featured Posts</h2>
